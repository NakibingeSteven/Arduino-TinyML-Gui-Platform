...
class MLGui:
    def __init__(self):
        ...
        self.topLevel.title("SAN Machine Learning Trainer")
    ...
    def create_gui(self):
        ...
        title_label = tk.Label(frame, text="SAN Machine Learning Trainer", font=("Helvetica", 16))
        ...
        self.data_label = tk.Label(data_frame, text="Data will be displayed here", font=("Helvetica", 12))
    ...
    def make_data(self):
        ...
        self.data_label.config(text="Data created:\n" + str(self.X))
